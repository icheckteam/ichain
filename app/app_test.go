...
func Test_Genesis(t *testing.T) {
	...
	adminCreated1 := types.NewAdminUser(publicKey1, nil, "IChain", "ch")
...
func fakeAssetAccount(cc *IchainApp, ctx sdk.Context, cash sdk.Coins, typ string, entityName string) sdk.Address {
...
func fakeOpAccount(cc *IchainApp, ctx sdk.Context, typ string, entityName string) (sdk.Address, crypto.PrivKey) {
...
func fakeAdminAccount(cc *IchainApp, ctx sdk.Context, typ string, entityName string) (sdk.Address, crypto.PrivKey) {
	priv := crypto.GenPrivKeyEd25519()
	pub := priv.PubKey()
	addr := pub.Address()
...
// newTestIchainApp a ClearchainApp with an in-memory datastore
func newTestIchainApp() *IchainApp {
