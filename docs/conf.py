...
latex_documents = [
    (master_doc, 'Ichain.tex', u'Ichain Documentation',
...
man_pages = [
    (master_doc, 'ichain', u'Ichain Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Ichain', u'Ichain Documentation',
     author, 'Ichain', 'One line description of project.',
     'Miscellaneous'),
]